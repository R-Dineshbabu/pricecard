        ...
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <ul className="fa-ul">
              ...
              <li className={data.isDomain?"":"text-muted"}><span className="fa-li"><i className={data.isDomain?"fas fa-check":"fas fa-times"}></i></span>{data.plan==="PRO"?<><b>Unlimited</b> {data.domain}</>:data.domain} </li>
